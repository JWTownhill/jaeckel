...
//
// This provides fifth-order convergence accuracy and is used for extreme
// moneyness ratios (|x| > 190 or |x| > 580) where third-order Householder
// is insufficient.
//
// Given Newton step ν = -g/g', and the ratios h₂ = g''/g', h₃ = g'''/g', h₄ = g''''/g',
// the Householder(4) iteration uses a more complex factor.
